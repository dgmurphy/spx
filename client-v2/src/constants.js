...
const DOC_FULL_IIR = 
 ...
 "FROM: Atropian Ministry of Security Protection\n\n" +
 "DATE OF PUBLICATION: 28-February-17\n\n" +
 "SERIAL: 80714TSP02\n\n" + 
 "COUNTRY: Atropia\n\n" +
 "SUBJECT: BFB Commanders Meet in Vetlia to Plan Atropian Attacks \n\n" +
 "WARNING: WARNING: THIS IS AN INFORMATION REPORT, NOT FINAL EVALUATED INTELLIGENCE. " +
 "REPORT IS UNCLASSIFIED//FOR EXERCISE PURPOSES ONLY.\n\n" +
